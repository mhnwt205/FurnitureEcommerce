...
<img alt="Rèm nhung xanh rêu trong phòng khách" className="w-full h-full object-cover rounded-sm" data-alt="Minimalist living room detail with moss green velvet curtains against a soft beige wall. A simple wooden stool stands nearby with a ceramic pot." src="https://lh3.googleusercontent.com/aida-public/AB6AXuDS54BzScFn2htXcEugkORQjdmaXOcgmPLrUnVO2wmqog5im2o3254hZMXvVuRBdx3bpci2omNPIxB3eeokmQ8Y4-mXEwXapslw3AzcOoc4zLQHmkWRb5ME7_URJt29fAZpHZSHiyZvRbKS5OblDZ-4esgZW8G5MQMrVB8Of5pnJaDL-gPb8oLVQOgl3FK2Ny8gu7nSiwpZYeOgRuU2IVCSnnpoN7mRTHGn27QKLLEI2spRKue85Sd3gplbrQNZyoN_IR6kscbqsfs"/>
<img alt="Ghế bọc vải xanh đậm trong góc phòng" className="w-full h-full object-cover rounded-sm" data-alt="A beautiful dark green upholstered chair sitting in a corner of a sunlit ivory room. The floor is made of light-colored wood planks." src="https://lh3.googleusercontent.com/aida-public/AB6AXuCcpkFvUpUJZtSGCWPz1_qsoutcSOqJqVGGpy-O4VbeWSDtznne-0Bqcm3SXm0rmsYmfFeJVrG-6KxKLI_c8s8hrVOKTgK5szkgxiEHCy8NnrhdEkp4Ho0vWcf2pfDCtxAOcrC4PT56WRzD7w_nKS9UIR1QLmuN6TF0IamSCJh29QWJVelRfRfX5z7YrTJsqhKGMnIdcDDFlprt-nudU6Lq29UznKp6gtxiBTI38gLVvEygejMTTzeAlKcG8E_usnQtRXTwJr07iDI"/>
<img alt="Bình gốm xanh và trung tính trên kệ gỗ" className="w-full h-full object-cover rounded-sm" data-alt="Interior decor details with a collection of green and neutral ceramic vases on a dark oak shelf, styled in a minimalist and luxury way." src="https://lh3.googleusercontent.com/aida-public/AB6AXuCrURLS77GTWxBtNNqLIOytLqEAIE5DECZmL9vRbHlSsYP3UJoeSomczV_yy6C6t1uxhDriC4FKheOVeXl6d7p6AXysQRCyCq6hi-ct0E4djMr4yvHjNmt5TPMKh2uVQAQhyF5FWNwvhS0HP6IXmseASG_s_WSwHydWDnVUOh8R_POxwXUXxNs9gmTS5T7cIIrrr5YNofmzV73QmqGOhcyiDNDpY1NdhUhUunhZWJLElY_rgqt25VO8WOcJGFaUoV1fw6FgWsob4pw"/>
</div>
</section>
{/*  */}
<section className="scroll-reveal">
